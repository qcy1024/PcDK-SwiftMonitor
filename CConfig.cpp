...
char* CConfig::getString(const char* p_itemname) const
{
    std::vector<p_confItem>::const_iterator pos;
    for( pos = m_confItemList.cbegin(); pos != m_confItemList.cend(); ++pos )
    {
...
int CConfig::getIntDefault(const char* p_itemname,const int def) const
{
    std::vector<p_confItem>::const_iterator pos;
    for( pos = m_confItemList.begin(); pos != m_confItemList.end(); ++pos )
    {
